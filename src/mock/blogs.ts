...
export const latestBlogs: BlogPost[] = [
  {
    ...
    translations: {
      "en-gb": {
        ...
        content:
          "Dubai has announced ambitious plans to develop a new district centered around physical gold, reinforcing its long-standing position as a global hub for precious metals trading. The proposed development is expected to integrate gold markets, luxury retail, secure vaulting facilities, and high-end residential and commercial spaces, creating a vibrant ecosystem built around the bullion industry. The initiative aligns with the emirate’s broader strategy to diversify its economy, attract international investors, and solidify its reputation as a premier destination for commodities trading and wealth management.",
      },
      // ar: {
