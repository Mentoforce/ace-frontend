...
// const clients = [
//   { icon: IconBuildingBank, label: "Property Investors" },
//   { icon: IconHome, label: "End Users & Homeowners" },
//   { icon: IconWorld, label: "International Buyers" },
//   { icon: IconUsers, label: "Relocating Families" },
//   { icon: IconTrendingUp, label: "Wealth Builders" },
// ];
...
//       <div className="w-8 h-px bg-[#C28A2A]" />
//       <span className="text-[11px] tracking-[0.25em] uppercase text-[#C28A2A] font-medium font-sans">
//         {text}
//       </span>
//     </div>
//   );
...
//               Built for{" "}
//               <em className="not-italic text-[#C28A2A]">Investors.</em>
//               <br />
//               Designed for{" "}
//               <em className="not-italic text-[#C28A2A]">Growth.</em>
//             </h1>
...
//                   <span className="font-serif text-5xl font-didot text-[#e0e0e0]/80 group-hover:text-[#e0e0e0] transition-colors leading-none">
//                     {p.num}
//                   </span>
//                 </div>
//                 <div>
...
//       {/* ── SERVICES ── */}
//       <section id="services" className="bg-[#EEEEEE]/50 py-24 lg:py-32">
...
//               <div
//                 key={s.title}
//                 className="bg-white p-8 group hover:bg-[#0c2848]/20 transition-colors duration-300"
//               >
//                 {/* <div className="w-8 h-px bg-[#c29a1f] mb-6 group-hover:w-12 transition-all duration-300" /> */}
//                 <h3 className="text-[#0c2848] font-didot group-hover:text-white text-[13.5px] font-semibold tracking-wide mb-3 transition-colors">
//                   {s.title}
//                 </h3>
//                 <p className="text-[212121] font-montserrat group-hover:text-white/50 text-[13px] leading-relaxed font-light transition-colors">
//                   {s.desc}
//                 </p>
//               </div>
//             ))}
...
//                 <div
//                   key={c.label}
//                   className="bg-white/5 border border-[#c29a1f]/20 p-6 text-center group hover:bg-[#c29a1f]/10 hover:border-[#C28A2A]/50 transition-all duration-200"
//                 >
//                   <div className="flex justify-center mb-4">
//                     <Icon
//                       size={32}
//                       stroke={1.5}
//                       className="text-[#C28A2A] group-hover:text-[#c29a1f] transition-colors duration-200"
//                     />
//                   </div>
